...
@Service
public class TopicDataServiceImpl
        implements TopicDataService {

    private static final Logger logger =
            LoggerFactory.getLogger(TopicDataServiceImpl.class);
    ...
    // @Cacheable : method result will be cached with topicCache cache name
    // using key as passed topicId.
    // It means for different topicId, result will be cached with different
    // key but with same cache name.
    ...
    // @CachePut : method will execute for every call and method result will
    // be added or updated in cache corresponding to key for given cache name.
    // NOTE : This method has ability to change values in redis cache and
    //        and effect methods : getTopic, getById
    // So, have same value and key combinations
    @Caching(
    ...
    public Topic updateTopic(Topic topic, String id) {
        ...
        logger.info("Inside Topic Data service to update topic record" +
                " based on id in db");
    ...
    // NOTE : @CacheEvict : The method will execute every call and
    // all the entries of caches will be removed.
    @Caching(
            evict = {
    ...
    public void deleteTopic(String id) {
        logger.info("Inside Topic Data service to delete topic" +
                " record based on id in db");
        topicDataManager.deleteTopic(id);
    }
    ...
    public Topic getById(String id) {
        logger.info("Inside Topic Data service to get topic" +
                " record based on id using getById");
    ...
    public Topic getByIdAndName(String id, String name) {
        logger.info("Inside Topic Data service to get topic record" +
                " from db using id and name");
